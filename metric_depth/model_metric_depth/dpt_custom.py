...
class DepthAnythingV2(nn.Module):
    # Keep a distinct ID even while this experimental file happens to match
    # dpt.py. Change the ID whenever its forward/head semantics change.
    ...
    def __init__(
        ...
        self.depth_head = DPTHead_custom(self.pretrained.embed_dim, features, use_bn, out_channels=out_channels, use_clstoken=use_clstoken)
